// C program containing all the parts of C taught by Mam Nudrat Habib Till 17th Of June 2022
...
if (b=='n'|| b=='N')
{
    ...
    default:
     ...
     {
     case 1:
           printf("You have been enrolled in KPK Sehat Insaaf Health Program");
        break;
     case 2:
           printf("You have been enrolled in Punjab Prime Minister Laptop Scheme");
           break;
     case 3:
           printf("You have been enrolled in  Balochistan Education For All Scheme");
           break;
     case 4:
           printf("You have been enrolled in Sindh  Health Program");
           break;
     case 5:
